<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column prop="userName" label="教师姓名" width="250" align="center"/>
...
export default {
  ...
  methods: {
    ...
    fetchData(page=1) {
      ...
      team.listTeach({"page": this.page, "limit": this.limit, "teamId": this.teamId})
        .then(response => {
    ...
    removeById(id) {
      // this.visible = true
      team.deleteTeach(id).then(response => {
        console.log("删除成功")
        this.fetchData(this.page)
      })
    },
    ...
    onSubmit () {
      ...
      team.importTeach(formData).then(response => {
        console.log("上传成功")
        this.fetchData()
        this.delFile()
      })
