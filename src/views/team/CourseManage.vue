<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column prop="name" label="课程名称" width="250" align="center"/>
...
export default {
  ...
  methods: {
    ...
    fetchData(page=1) {
      ...
      team.listCourse({"page": this.page, "limit": this.limit, "teamId": this.teamId})
        .then(response => {
    ...
    removeById(id) {
      // this.visible = true
      team.deleteCourse(id).then(response => {
        console.log("删除成功")
        this.fetchData(this.page)
      })
    },
    ...
    onSubmit () {
      ...
      team.importCourse(formData).then(response => {
        console.log("上传成功")
        this.fetchData()
        this.delFile()
      })
