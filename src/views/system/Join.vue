<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column prop="userName" label="用户昵称" width="100" align="center" />
...
export default {
  ...
  methods: {
    ...
    fetchData(page=1) {
      ...
      join.getPageList({"page": this.page, "limit": this.limit})
        .then(response => {
    ...
    agree(id) {
      this.list.forEach(userTeam => {
        if (userTeam.id === id) {
          this.userTeam = userTeam
          this.userTeam.joinState = 1
          console.log(id,this.userTeam)
          return
        }
      })
      join.audit(this.userTeam).then(response => {
